...
<div id="<?php echo $prefix;?>main" class="<?php echo $prefix;?>row">
    ...
    <div id="<?php echo $prefix;?>mainbody" class="ex-column" style="width:<?php echo $width['component'];?>%;">
    ...
    <div id="<?php echo $prefix;?>sidebar-a" class="ex-column clearfix" role="complementary" style="width:<?php echo $expose->getSidebarsWidth('sidebar-a') ?>%;">
