...
<div id="main" class="container">
    ...
    <div id="mainbody" class="grid<?php echo $grid['component'];?> offset<?php echo $grid['sidebar-a'] + $grid['sidebar-b']; ?>">
    ...
    <div id="sidebar-a" class="grid<?php echo $grid['sidebar-a'];?> inset<?php echo ($grid['component'] + $grid['sidebar-a'] + $grid['sidebar-b']) ?>" role="complementary">
    ...
    <?php /**Begin Sidebar-B**/ if($expose->countModules('sidebar-b')): ?>
        ...
        <div id="sidebar-b" class="grid<?php echo $grid['sidebar-b'] ?> inset<?php echo ($grid['component'] + $grid['sidebar-b']) ?>" role="complementary">
